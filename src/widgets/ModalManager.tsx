...
const ModalManager = () => {
  ...
  // У него самый высокий приоритет или он должен быть поверх всего.
  ...
  // Он может быть поверх попапов авторизации.
  if (confirmationOpen) {
  ...
  // Если попапы авторизации не открыты или текущий view не задан, не рендерим ничего.
